...
public class MainActivity extends BaseActivity implements MainView {
    ...
    @Bind(R.id.floatingActionButton) FloatingActionButton sendbt;
...
//        mMainPresenter.getWeatherData("北京");
        ...
        mMainPresenter.getPlaceAndWeatherData("上海");
        ...
        sendbt.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                if(option == -1) {
                    sendMesseng();
                    //Toast.makeText(MainActivity.this, "功能开启", Toast.LENGTH_SHORT).show();
                }
                else if(option==1) {
                    //Toast.makeText(MainActivity.this, "功能关闭", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    public void sendMesseng(){
        SmsManager manager = SmsManager.getDefault();

        manager.sendTextMessage("17801093073", null, "天气恶劣，请看详细介绍by天气助手", null, null);
