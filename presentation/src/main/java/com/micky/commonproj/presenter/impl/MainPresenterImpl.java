...
public class MainPresenterImpl extends BasePresenterImpl implements MainPresenter {
    ...
    public void getWeatherData(String place) {
        ...
        mSubscriptions.add(ServiceManager.createService(BaseApplication.getInstance(), WeatherService.class)
                .getWeatherInfo(place, Constants.BAIDU_AK)
    ...
    public void getPlaceAndWeatherData(String place) {
        ...
        Observable weatherObservable =  ServiceManager.createService(BaseApplication.getInstance(), WeatherService.class)
                .getWeatherInfo(place, Constants.BAIDU_AK);
